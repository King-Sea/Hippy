...
void DomManager::AddEventListener(std::weak_ptr<RootNode> root_node, uint32_t id, const std::string& name, uint64_t listener_id,
...
void DomManager::RemoveEventListener(std::weak_ptr<RootNode> root_node, uint32_t id, const std::string &name,
